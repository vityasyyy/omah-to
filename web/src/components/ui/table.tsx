...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn('[&_tr]: bg-neutral-200', className)}
      {...props}
    />
  )
}
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-16 px-4 text-left align-middle font-bold text-black dark:text-neutral-400 [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<'td'>) {
  return (
    <td
      ...
      className={cn(
        'h-16 px-4 text-left align-middle text-black [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
