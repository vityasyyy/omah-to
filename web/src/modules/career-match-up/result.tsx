    ...
    <main className='flex flex-col'>
      <Container>
        ...
        <Image
          ...
          width={1000}
          height={40}
          className='aspect-[360/232] w-full object-cover md:aspect-[1204/496]'
        />
      ...
      <section className='h-[700px]'>
        <div className='flex flex-col items-center justify-center space-x-2 text-2xl font-bold md:flex-row md:text-4xl'>
